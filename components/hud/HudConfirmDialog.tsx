          ...
          >
            ...
            <div className="relative space-y-4">
              <div className="flex items-center gap-2">
                <span className="h-2 w-2 rounded-full bg-hud-amber shadow-[0_0_8px_var(--hud-amber)]" />
                <h2
                  id={titleId}
              ...
              <div className="flex flex-col-reverse gap-2 pt-1 sm:flex-row sm:justify-end">
                <button
                  ...
                  className="min-h-11 rounded border border-hud-border px-4 py-2.5 font-mono text-sm tracking-widest text-muted-foreground transition-colors hover:bg-accent hover:text-accent-foreground focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-hud-cyan"
                >
                  {cancelLabel}
                </button>
                <button
