    ...
    >
      ...
      >
        ...
        <div className="mt-4 flex flex-wrap gap-3">
          ...
          >
            <GitHubIcon size={22} />
            <b className="border-l border-[var(--accent)] bg-[var(--bg)] px-1 text-lg">Github</b>
          </a>
          <a
          ...
          >
            ...
            <b className="border-l border-[var(--accent)] bg-[var(--bg)] px-1 text-lg">Credly</b>
          </a>
          <a
            href="#contacto"
            className="flex items-center gap-2 text-[var(--text)] transition-colors duration-500 hover:text-[var(--accent)]"
          >
            <Mail size={22} />
            <b className="border-l border-[var(--accent)] bg-[var(--bg)] px-1 text-lg">Contacto</b>
          </a>
        </div>
      </motion.article>
